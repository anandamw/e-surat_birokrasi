    ...
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                    <!-- parent pages-->
                    <a class="nav-link" href="/settings/{{ auth()->user()->role }}">
                        <div class="d-flex align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <!-- parent pages-->
                    <a class="nav-link" href="/settings/{{ auth()->user()->role }}/kategori">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                    ...
                    <a class="nav-link" href="/settings/{{ auth()->user()->role }}/tipe">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                    ...
                    <!-- parent pages-->
                    <a class="nav-link" href="/settings/{{ auth()->user()->role }}/pengabsahan">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                    ...
                    <a class="nav-link" href="/settings/{{ auth()->user()->role }}/fakultas">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                                <span class="fas fa-file-signature"></span>
                            </span>
                ...
                <li class="nav-item">
                    <div class="settings mb-3 position-absolute start-0 bottom-0">
                        <a class=" nav-link" type="button" href="/dashboard/{{ auth()->user()->role }}">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
