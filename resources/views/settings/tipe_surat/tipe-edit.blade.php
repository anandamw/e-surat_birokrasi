    ...
    <div class="card-header">
      <div class="row flex-between-end">
        <div class="col-auto align-self-center">
          <h5 class="mb-0" data-anchor="data-anchor">Edit Tipe Surat</h5>
        </div>
      </div>
    </div>
    <div class="card-body pt-0">
      <form>
        <div class="mb-3"><label class="form-label" for="basic-form-name">Masukkan Tipe Surat</label><input
            class="form-control" id="basic-form-name" type="text" value="Surat Libur" placeholder="Masukkan Tipe Surat ..." /></div>
