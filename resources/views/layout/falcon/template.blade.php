                    ...
                    <div class="d-flex flex-between-center">
                        ...
                        <a class="navbar-brand me-1 me-sm-3" href="index.html">
                            <div class="d-flex align-items-center"><img class="me-2"
                                    src="{{ asset('falcon') }}/assets/img/icons/spot-illustrations/falcon.png"
                                    alt="" width="40" /><span
                                        ...
                                        <div class="scrollbar list py-3" style="max-height: 24rem;">
                                            ...
                                            <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs-11 pt-0 pb-2">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="file-thumbnail me-2"><img
                                                            ...
                                                            src="{{ asset('falcon') }}/assets/img/products/3-thumb.png"
                                                            alt="" /></div>
                                                    <div class="flex-1">
                                            ...
                                            <a class="dropdown-item px-x1 py-2" href="#!">
                                                <div class="d-flex align-items-center">
                                                    <div class="file-thumbnail me-2"><img class="img-fluid"
                                                            src="{{ asset('falcon') }}/assets/img/icons/zip.png"
                                                            alt="" /></div>
                                                    <div class="flex-1">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-l status-online me-2">
                                                        <img class="rounded-circle"
                                                            src="{{ asset('falcon') }}/assets/img/team/1.jpg"
                                                            alt="" />
                                                    </div>
                                                    <div class="flex-1">
                                            ...
                                            <a class="dropdown-item px-x1 py-2" href="pages/user/profile.html">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-l me-2">
                                                        <img class="rounded-circle"
                                                            src="{{ asset('falcon') }}/assets/img/team/2.jpg"
                                                            alt="" />
                                                    </div>
                                                    <div class="flex-1">
                                            ...
                                            <a class="dropdown-item px-x1 py-2" href="pages/user/profile.html">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-l me-2">
                                                        <img class="rounded-circle"
                                                            src="{{ asset('falcon') }}/assets/img/team/3.jpg"
                                                            alt="" />
                                                    </div>
                                                    <div class="flex-1">
                          ...
                          <div class="col-12"><a class="btn btn-outline-primary btn-sm mt-4" href="#!">Show
                            ...
                            <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser"
                                    ...
                                    <div class="avatar avatar-xl">
                                        <img class="rounded-circle"
                                            src="{{ asset('falcon') }}/assets/img/team/3-thumb.png" alt="" />
                                    </div>
                                </a>
