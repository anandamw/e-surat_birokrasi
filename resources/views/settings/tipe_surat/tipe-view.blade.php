        ...
        <div class="tab-pane preview-tab-pane active" role="tabpanel"
          ...
          <div id="tableExample" data-list='{"valueNames":["name","email","age"],"page":5,"pagination":true}'>
            <div class="table-responsive scrollbar">
                <div class="">
                    <a class="btn btn-primary me-1 mb-1" href="/settings/tipe_tambah">Tambah Tipe Surat</a>
                </div>
              <table class="table table-bordered table-striped fs-10 mb-0">
                <thead class="bg-200">
                  <tr>
                    <th class="text-900 sort">No</th>
                    <th class="text-900 sort">Nama Tipe Surat</th>
                ...
                <tbody class="list">
                  <tr>
                    <td class="no">1</td>
                    <td class="nama">Surat Libur</td>
                    <td class="nama">Surat Edaran</td>
                    <td class="action">
                        <a class="btn btn-info me-1 mb-1" href="/settings/tipe_edit">Edit</a>
