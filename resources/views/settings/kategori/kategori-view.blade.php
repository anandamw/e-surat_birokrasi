                        ...
                        <div class="table-responsive scrollbar">
                            <div class="">
                                <button class="btn btn-primary me-1 mb-1" type="button" data-bs-toggle="modal"
                                    data-bs-target="#authentication-modal">Tambah Kategori</button>
                            </div>
                            <table class="table table-bordered table-striped fs-10 mb-0">
                                <thead class="bg-200">
                                    <tr> 
                                        <th class="text-900 sort text-center">No</th>
                                        <th class="text-900 sort text-center">Nama Kategori</th>
                                ...
                                <tbody class="list">
                                    @foreach ($kategori as $item)
                                        ...
                                        <div class="modal fade" id="destroyer-{{ $item->token_kategori }}" tabindex="-1"
                                                ...
                                                <div class="modal-content border-0">
                                                    ...
                                                    <div class="modal-body py-4 px-5 text-center">
                                                        ...
                                                        <a class="btn btn-danger"
                                                            href="/settings/{{ auth()->user()->role }}/kategori/{{ $item->token_kategori }}/del">Hapus</a>
                                                    </div>
                                        ...
                                        <div class="modal fade" id="authentication-{{ $item->token_kategori }}"
                                            ...
                                            <div class="modal-dialog mt-6" role="document">
                                                <div class="modal-content border-0">
                                                    ...
                                                    <div class="modal-body py-4 px-5">
                                                        ...
                                                        <form
                                                            action="/settings/{{ auth()->user()->role }}/kategori/{{ $item->token_kategori }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="mb-3"><label class="form-label"
                                                                    for="modal-auth-name">Nama
                                                                    Kategori</label><input class="form-control"
                                                                    value="{{ $item->nama_kategori }}" type="text"
        ...
        <div class="modal fade" id="authentication-modal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog mt-6" role="document">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body py-4 px-5">
                        <form action="/settings/{{ auth()->user()->role }}/kategori" method="POST">
                            @csrf
                            <div class="mb-3">
