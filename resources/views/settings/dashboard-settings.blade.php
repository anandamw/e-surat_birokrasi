            ...
            <div class="card bg-100 shadow-none border">
                <div class="row gx-0 flex-between-center">
                    <div class="col-sm-auto d-flex align-items-center"><img class="ms-n2"
                            src="{{ asset('falcon') }}/assets/img/illustrations/crm-bar-chart.png" alt=""
                            width="90" />
                        <div>
                            <h6 class="text-primary fs-10 mb-0">Welcome to coba</h6>
                            <h4 class="text-primary fw-bold mb-0">E-Surat <span class="text-info fw-medium">BIROKRASI</span>
                            </h4>
                        </div><img class="ms-n4 d-md-none d-lg-block"
                            src="{{ asset('falcon') }}/assets/img/illustrations/crm-line-chart.png" alt=""
                            width="150" />
                    </div>
                        ...
                        <div class="col-xxl-12 col-md-7">
                            ...
                            <div class="d-flex flex-between-center border-bottom py-3">
                                <div class="d-flex"><img class="me-2"
                                        src="{{ asset('falcon') }}/assets/img/crm/social.svg" width="16" height="16"
                                        alt="..." />
