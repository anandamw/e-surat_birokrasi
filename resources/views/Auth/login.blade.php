  ...
  <body>
                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    <div class="position-relative p-4 pt-md-5 pb-md-7" data-bs-theme="light">
                      <div class="bg-holder bg-auth-card-shape" style="background-image:url({{ asset('falcon') }}/assets/img/icons/spot-illustrations/half-circle.png);"></div><!--/.bg-holder-->
                      <div class="z-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-5 d-inline-block fw-bolder" href="{{ asset('falcon') }}/index.html">falcon</a>
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
      ...
      <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
        ...
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-start"><img class="me-2" src="{{ asset('falcon') }}/assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
            <div class="flex-1">
              ...
              <p class="fs-10 mb-0">Switch your language direction </p><a class="fs-10" href="{{ asset('falcon') }}/documentation/customization/configuration.html">RTL Documentation</a>
            </div>
          </div>
        ...
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-start"><img class="me-2" src="{{ asset('falcon') }}/assets/img/icons/arrows-h.svg" width="20" alt="" />
            <div class="flex-1">
              ...
              <p class="fs-10 mb-0">Toggle container layout system </p><a class="fs-10" href="{{ asset('falcon') }}/documentation/customization/configuration.html">Fluid Documentation</a>
            </div>
          </div>
        ...
        <p> <a class="fs-10" href="{{ asset('falcon') }}/modules/components/navs-and-tabs/vertical-navbar.html#navbar-styles">See Documentation</a></p>
        <div class="btn-group d-block w-100 btn-group-navbar-style">
          <div class="row gx-2">
    ...
    <script src="{{ asset('falcon') }}/polyfill.io/v3/polyfill.min58be.js?features=window.scroll"></script>
