                                                    ...
                                                    <div class="modal-body py-4 px-5">
                                                        <form action="/settings/kategori/{{ $item->token_kategori }}" method="POST">
                                                            ...
                                                            <div class="mb-3"><label class="form-label"
                                                                    ...
                                                                    value="{{ $item->nama_kategori }}" type="text" autocomplete="on"
                                                                    id="modal-auth-name" name="nama_kategori" />
                                                            </div>
                    ...
                    <div class="modal-body py-4 px-5">
                        <form action="" method="POST">
                            ...
                            <div class="mb-3"><label class="form-label" for="modal-auth-name">Nama
                                    Kategori</label><input class="form-control" type="text" autocomplete="on"
                                    id="modal-auth-name" name="nama_kategori" />
                            </div>
