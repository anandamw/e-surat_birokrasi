    ...
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                    <!-- parent pages-->
                    <a class="nav-link" href="/dashboard/{{ auth()->user()->role }}">
                        <div class="d-flex align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse" id="pengajuan">
                        @foreach (kategori() as $item)
                            <li class="nav-item">
                                <a class="nav-link"
                                    href="/pengajuan/{{ $item->token_kategori }}/{{ auth()->user()->role }}">
                                    <div class="d-flex align-items-center">
                    ...
                    <a class="nav-link" href="/rekap/{{ auth()->user()->role }}">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
                ...
                <li class="nav-item">
                    <div class="settings mb-3 position-absolute start-0 bottom-0">
                        <a class=" nav-link" type="button" aria-expanded="false"
                            href="{{ auth()->user()->role == 'admin' ? '/settings/admin' : '/settings' }}">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
