                          ...
                          <div class="modal-content border-0">
                            <div class="modal-header px-5 position-relative modal-shape-header bg-shape">
                              <div class="position-relative z-1">
                                <h4 class="mb-0 text-white" id="authentication-modal-label">Edit Kategori</h4>
                            ...
                            <div class="modal-body py-4 px-5">
                              <div class="mb-3"><label class="form-label" for="modal-auth-name">Nama
                                  Kategori</label><input class="form-control" value="Surat Edaran" type="text" autocomplete="on"
                                  id="modal-auth-name" />
                              </div>
