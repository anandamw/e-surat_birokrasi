...
class KategoriController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/settings/'. auth()->user()->role .'/kategori')->with(['create' => "Berhasil menambahkan Data $nama_kategori"]);
    }
    ...
    public function update(Request $request, $q)
    {
        ...
        return redirect('/settings/'.auth()->user()->role .'/kategori')->with(['edit' => "Berhasil mengedit Data $nama_kategori"]);
    }
    ...
    public function destroy($q)
    {
        ...
        if($data){
            ...
            $raw->delete();
            return redirect('/settings/'. auth()->user()->role  .'/kategori')->with(['delete' => "Berhasil menghapus data "]);
        }
    }
}
