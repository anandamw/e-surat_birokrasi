                  ...
                  <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                      ...
                      <a class="dropdown-item fs-10 px-x1 py-1 hover-primary" href="app/e-commerce/customers.html">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="fw-normal title">E-commerce <span
                              class="fas fa-chevron-right mx-1 text-500 fs-11" data-fa-transform="shrink-2"></span>
                            Customers</div>
                        </div>
                      </a>
                      ...
                      <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs-11 pt-0 pb-2">Files</h6><a
                        ...
                        <div class="d-flex align-items-center">
                          <div class="file-thumbnail me-2"><img class="border h-100 w-100 object-fit-cover rounded-3"
                              src="{{ asset('falcon') }}/assets/img/products/3-thumb.png" alt="" /></div>
                          <div class="flex-1">
                      ...
                      <a class="dropdown-item px-x1 py-2" href="#!">
                        <div class="d-flex align-items-center">
                          <div class="file-thumbnail me-2"><img class="img-fluid"
                              src="{{ asset('falcon') }}/assets/img/icons/zip.png" alt="" /></div>
                          <div class="flex-1">
                      ...
                      <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs-11 pt-0 pb-2">Members</h6><a
                        ...
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-l status-online me-2">
                            <img class="rounded-circle" src="{{ asset('falcon') }}/assets/img/team/1.jpg"
                              alt="" />
                          </div>
                          <div class="flex-1">
                      ...
                      <a class="dropdown-item px-x1 py-2" href="pages/user/profile.html">
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-l me-2">
                            <img class="rounded-circle" src="{{ asset('falcon') }}/assets/img/team/2.jpg"
                              alt="" />
                          </div>
                          <div class="flex-1">
                      ...
                      <a class="dropdown-item px-x1 py-2" href="pages/user/profile.html">
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-l me-2">
                            <img class="rounded-circle" src="{{ asset('falcon') }}/assets/img/team/3.jpg"
                              alt="" />
                          </div>
                          <div class="flex-1">
            ...
            <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                      ...
                      <div class="list-group list-group-flush fw-normal fs-10">
                          ...
                          <a class="notification notification-flush notification-unread" href="#!">
                            <div class="notification-avatar">
                              <div class="avatar avatar-2xl me-3">
                                <img class="rounded-circle" src="{{ asset('falcon') }}/assets/img/team/1-thumb.png"
                                  alt="" />
                              </div>
                            </div>
                            ...
                            <div class="notification-avatar">
                              <div class="avatar avatar-2xl me-3">
                                <img class="rounded-circle"
                                  src="{{ asset('falcon') }}/assets/img/icons/weather-sm.jpg" alt="" />
                              </div>
                            </div>
                            <div class="notification-body">
                          ...
                          <a class="border-bottom-0 notification-unread  notification notification-flush"
                            ...
                            <div class="notification-avatar">
                              <div class="avatar avatar-xl me-3">
                                <img class="rounded-circle" src="{{ asset('falcon') }}/assets/img/logos/oxford.png"
                                  alt="" />
                              </div>
                            </div>
                            <div class="notification-body">
                        ...
                        <div class="list-group-item">
                          <a class="border-bottom-0 notification notification-flush" href="#!">
                            <div class="notification-avatar">
                              <div class="avatar avatar-xl me-3">
                                <img class="rounded-circle" src="{{ asset('falcon') }}/assets/img/team/10.jpg"
                                  alt="" />
                              </div>
                            </div>
                            <div class="notification-body">
                        ...
                        <div class="row text-center gx-0 gy-0">
                          ...
                          <div class="col-4"><a
                              ...
                              href="https://mailbluster.com/" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/mailbluster.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              ...
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/google.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/spotify.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/steam.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/github-light.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/discord.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/xbox.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/trello.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/hp.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/linkedin.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/twitter.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/facebook.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/instagram.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/pinterest.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/slack.png" alt=""
                                width="40" height="40" />
                          ...
                          <div class="col-4"><a
                              class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                              href="#!" target="_blank"><img class="rounded"
                                src="{{ asset('falcon') }}/assets/img/nav-icons/deviantart.png" alt=""
                                width="40" height="40" />
              ...
              <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button"
                  ...
                  <div class="avatar avatar-xl">
                    <img class="rounded-circle" src="{{ asset('falcon') }}/assets/img/team/3-thumb.png"
                      alt="" />
                  </div>
                </a>
                ...
                <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0" aria-labelledby="apps">
                  <div class="card navbar-card-app shadow-none dark__bg-1000">
                    <div class="card-body scrollbar max-h-dropdown"><img class="img-dropdown"
                        src="{{ asset('falcon') }}/assets/img/icons/spot-illustrations/authentication-corner.png"
                        width="130" alt="" />
                      <div class="row">
                        ...
                        <div class="col-6 col-xxl-3">
                          <div class="nav flex-column">
                            <p class="nav-link text-700 mb-0 fw-bold">FAQ</p><a
                              class="nav-link py-1 link-600 fw-medium" href="pages/faq/faq-basic.html">Faq basic</a><a
                  ...
                  <div class="list-group list-group-flush fw-normal fs-10">
                    ...
                    <div class="list-group-item">
                      <a class="notification notification-flush" href="#!">
                        <div class="notification-avatar">
                          <div class="avatar avatar-2xl me-3">
                            <img class="rounded-circle" src="{{ asset('falcon') }}/assets/img/icons/weather-sm.jpg"
                              alt="" />
                          </div>
                        </div>
                        <div class="notification-body">
                  ...
                  <div class="card-body px-3">
                    <div class="row text-center gx-0 gy-0">
                      ...
                      <div class="col-4"><a
                          class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                          href="#!" target="_blank"><img class="rounded"
                            src="{{ asset('falcon') }}/assets/img/nav-icons/hp.png" alt="" width="40"
                            height="40" />
                          <p class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">Hp</p>
                        </a></div>
                      <div class="col-12">
                    ...
                    <div class="card-body scrollbar max-h-dropdown"><img class="img-dropdown"
                      ...
                      <div class="row">
                        ...
                        <div class="col-6 col-xxl-3">
                          <div class="nav flex-column">
                            <p class="nav-link text-700 mb-0 fw-bold">FAQ</p><a
                              class="nav-link py-1 link-600 fw-medium" href="pages/faq/faq-basic.html">Faq
            ...
            <div class="modal-body py-4 px-5">
              ...
              <div class="row g-2 mt-2">
                ...
                <div class="col-sm-6"><a class="btn btn-outline-facebook btn-sm d-block w-100"
                    href="#"><span class="fab fa-facebook-square me-2" data-fa-transform="grow-8"></span>
                    facebook</a></div>
              </div>
            </div>
          </div>
