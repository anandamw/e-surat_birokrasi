...
<body>
        ...
        <div class="container-fluid">
            <div class="row min-vh-100 flex-center g-0">
                <div class="col-lg-8 col-xxl-5 py-3 position-relative"><img class="bg-auth-circle-shape"
                        src="{{ asset('falcon') }}/assets/img/icons/spot-illustrations/bg-shape.png" alt=""
                        width="250"><img class="bg-auth-circle-shape-2"
                        src="{{ asset('falcon') }}/assets/img/icons/spot-illustrations/shape-1.png" alt=""
                        width="150">
                                ...
                                <div class="col-md-5 text-center bg-card-gradient">
                                    <div class="position-relative p-4 pt-md-5 pb-md-7" data-bs-theme="light">
                                        ...
                                        <div class="z-1 position-relative"><a
                                                ...
                                                href="{{ asset('falcon') }}/index.html">falcon</a>
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
        ...
        <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherAuto"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{ asset('falcon') }}/assets/img/generic/falcon-mode-auto.jpg"
                ...
                <div class="d-flex align-items-start"><img class="me-2"
                    ...
                    <div class="flex-1">
                        ...
                        <p class="fs-10 mb-0">Switch your language direction </p><a class="fs-10"
                            href="{{ asset('falcon') }}/documentation/customization/configuration.html">RTL
                            Documentation</a>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-start"><img class="me-2"
                    ...
                    <div class="flex-1">
                        ...
                        <p class="fs-10 mb-0">Toggle container layout system </p><a class="fs-10"
                            href="{{ asset('falcon') }}/documentation/customization/configuration.html">Fluid
                            Documentation</a>
                    </div>
                </div>
            ...
            <p> <a class="fs-10"
                    href="{{ asset('falcon') }}/modules/components/navs-and-tabs/vertical-navbar.html#navbar-styles">See
                    Documentation</a></p>
            <div class="btn-group d-block w-100 btn-group-navbar-style">
                <div class="row gx-2">
